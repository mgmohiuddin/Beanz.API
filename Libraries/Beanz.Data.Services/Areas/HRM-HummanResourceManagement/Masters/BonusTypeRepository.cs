...
namespace Beanz.Data.Services.Areas.HumanResourceManagement.Masters
{
    public class BonusTypeRepository : IBonusTypeRepository
    {
        ...
        public BonusTypeRepository(IMapper mapper)
        {
            _mapper = mapper;
        }

        public async Task<List<BonusTypeDTO>> GetBonusTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetMS_BonusTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@BonusTypeID", SqlDbType.Int) { Value = common.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BonusTypeDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BeanzResponseDTO> SetBonusTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.SetMS_BonusTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> PostBonusTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PostMS_BonusTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> DelBonusTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.DelMS_BonusTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<List<BeanzlookupDTO>> LookUpBonusTypesAsync(BeanzCommonDTO lookup)
        {
            string _sql = "hrms.LookupMS_BonusTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@BonusTypeID", SqlDbType.Int) { Value = lookup.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BeanzlookupDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BonusTypeViewModel> GetInfoBonusTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetInfoMS_BonusTypes";
            ...
            var _bonusTypeDTOList = new List<BonusTypeDTO>();
            bool _isBonusTypesConsumed = false;
            using (SqlConnection _sqlConnection = new SqlConnection(Utilities.Configuration.ConnectionString))
            {
                using (var objRecord = await SqlMapper.QueryMultipleAsync(_sqlConnection, _sql, p, commandType: CommandType.StoredProcedure))
                {
                    while (!objRecord.IsConsumed)
                    {
                        ...
                        var bonusTypeData = objTemp.Where(c => c.TableName == "MS_BonusTypes");
                        if (bonusTypeData.Count() > 0 && !_isBonusTypesConsumed)
                        {
                            _bonusTypeDTOList = _mapper.Map<List<BonusTypeDTO>>(bonusTypeData);
                            _isBonusTypesConsumed = true;
                            continue;
                        }
                    }
                }
                var _bonusTypeDTO = _bonusTypeDTOList.Where(x => x.BonusTypeID == common.PrimaryKeyID).FirstOrDefault();
                var result = new BonusTypeViewModel
                {
                    BonusTypes = _bonusTypeDTOList,
                    BonusType = _bonusTypeDTO
                };
                return result;
            }
        }

        public async Task<BonusTypeViewModel> PrintBonusTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PrintMS_BonusTypes";
            SqlParameter[] paramList =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> ApproveBonusTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.ApproveMS_BonusTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
