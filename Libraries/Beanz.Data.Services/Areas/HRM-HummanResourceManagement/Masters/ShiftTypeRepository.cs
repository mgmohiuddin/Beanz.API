...
namespace Beanz.Data.Services.Areas.HumanResourceManagement.Masters
{
    public class ShiftTypeRepository : IShiftTypeRepository
    {
        ...
        public ShiftTypeRepository(IMapper mapper)
        {
            _mapper = mapper;
        }

        public async Task<List<ShiftTypeDTO>> GetShiftTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetMS_ShiftTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@ShiftTypeID", SqlDbType.Int) { Value = common.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<ShiftTypeDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BeanzResponseDTO> SetShiftTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.SetMS_ShiftTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> PostShiftTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PostMS_ShiftTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> DelShiftTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.DelMS_ShiftTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<List<BeanzlookupDTO>> LookUpShiftTypesAsync(BeanzCommonDTO lookup)
        {
            string _sql = "hrms.LookupMS_ShiftTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@ShiftTypeID", SqlDbType.Int) { Value = lookup.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BeanzlookupDTO>(_sql, _parameters);
            return data;
        }

        public async Task<ShiftTypeViewModel> GetInfoShiftTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetInfoMS_ShiftTypes";
            ...
            var _shiftTypeDTOList = new List<ShiftTypeDTO>();
            bool _isShiftTypesConsumed = false;
            using (SqlConnection _sqlConnection = new SqlConnection(Utilities.Configuration.ConnectionString))
            {
                using (var objRecord = await SqlMapper.QueryMultipleAsync(_sqlConnection, _sql, p, commandType: CommandType.StoredProcedure))
                {
                    while (!objRecord.IsConsumed)
                    {
                        ...
                        var shiftTypeData = objTemp.Where(c => c.TableName == "MS_ShiftTypes");
                        if (shiftTypeData.Count() > 0 && !_isShiftTypesConsumed)
                        {
                            _shiftTypeDTOList = _mapper.Map<List<ShiftTypeDTO>>(shiftTypeData);
                            _isShiftTypesConsumed = true;
                            continue;
                        }
                    }
                }
                var _shiftTypeDTO = _shiftTypeDTOList.Where(x => x.ShiftTypeID == common.PrimaryKeyID).FirstOrDefault();
                var result = new ShiftTypeViewModel
                {
                    ShiftTypes = _shiftTypeDTOList,
                    ShiftType = _shiftTypeDTO
                };
                return result;
            }
        }

        public async Task<ShiftTypeViewModel> PrintShiftTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PrintMS_ShiftTypes";
            SqlParameter[] paramList =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> ApproveShiftTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.ApproveMS_ShiftTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
