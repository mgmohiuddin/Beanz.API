...
namespace Beanz.Data.Services.Areas.HumanResourceManagement.Masters
{
    public class TravelTypeRepository : ITravelTypeRepository
    {
        ...
        public TravelTypeRepository(IMapper mapper)
        {
            _mapper = mapper;
        }

        public async Task<List<TravelTypeDTO>> GetTravelTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetMS_TravelTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@TravelTypeID", SqlDbType.Int) { Value = common.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<TravelTypeDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BeanzResponseDTO> SetTravelTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.SetMS_TravelTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> PostTravelTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PostMS_TravelTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> DelTravelTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.DelMS_TravelTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<List<BeanzlookupDTO>> LookUpTravelTypesAsync(BeanzCommonDTO lookup)
        {
            string _sql = "hrms.LookupMS_TravelTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@TravelTypeID", SqlDbType.Int) { Value = lookup.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BeanzlookupDTO>(_sql, _parameters);
            return data;
        }

        public async Task<TravelTypeViewModel> GetInfoTravelTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetInfoMS_TravelTypes";
            ...
            var _travelTypeDTOList = new List<TravelTypeDTO>();
            bool _isTravelTypesConsumed = false;
            using (SqlConnection _sqlConnection = new SqlConnection(Utilities.Configuration.ConnectionString))
            {
                using (var objRecord = await SqlMapper.QueryMultipleAsync(_sqlConnection, _sql, p, commandType: CommandType.StoredProcedure))
                {
                    while (!objRecord.IsConsumed)
                    {
                        ...
                        var travelTypeData = objTemp.Where(c => c.TableName == "MS_TravelTypes");
                        if (travelTypeData.Count() > 0 && !_isTravelTypesConsumed)
                        {
                            _travelTypeDTOList = _mapper.Map<List<TravelTypeDTO>>(travelTypeData);
                            _isTravelTypesConsumed = true;
                            continue;
                        }
                    }
                }
                var _travelTypeDTO = _travelTypeDTOList.Where(x => x.TravelTypeID == common.PrimaryKeyID).FirstOrDefault();
                var result = new TravelTypeViewModel
                {
                    TravelTypes = _travelTypeDTOList,
                    TravelType = _travelTypeDTO
                };
                return result;
            }
        }

        public async Task<TravelTypeViewModel> PrintTravelTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PrintMS_TravelTypes";
            SqlParameter[] paramList =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> ApproveTravelTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.ApproveMS_TravelTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
