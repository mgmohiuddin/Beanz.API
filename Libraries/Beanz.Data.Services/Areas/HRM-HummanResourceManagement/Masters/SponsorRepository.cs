...
namespace Beanz.Data.Services.Areas.HumanResourceManagement.Masters
{
    public class SponsorRepository : ISponsorRepository
    {
        ...
        public SponsorRepository(IMapper mapper)
        {
            _mapper = mapper;
        }

        public async Task<List<SponsorDTO>> GetSponsorsAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetMS_Sponsors";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@SponsorID", SqlDbType.Int) { Value = common.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<SponsorDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BeanzResponseDTO> SetSponsorsAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.SetMS_Sponsors";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> PostSponsorsAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PostMS_Sponsors";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> DelSponsorsAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.DelMS_Sponsors";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<List<BeanzlookupDTO>> LookUpSponsorsAsync(BeanzCommonDTO lookup)
        {
            string _sql = "hrms.LookupMS_Sponsors";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@SponsorID", SqlDbType.Int) { Value = lookup.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BeanzlookupDTO>(_sql, _parameters);
            return data;
        }

        public async Task<SponsorViewModel> GetInfoSponsorsAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetInfoMS_Sponsors";
            ...
            var _sponsorDTOList = new List<SponsorDTO>();
            bool _isSponsorsConsumed = false;
            using (SqlConnection _sqlConnection = new SqlConnection(Utilities.Configuration.ConnectionString))
            {
                using (var objRecord = await SqlMapper.QueryMultipleAsync(_sqlConnection, _sql, p, commandType: CommandType.StoredProcedure))
                {
                    while (!objRecord.IsConsumed)
                    {
                        ...
                        var sponsorData = objTemp.Where(c => c.TableName == "MS_Sponsors");
                        if (sponsorData.Count() > 0 && !_isSponsorsConsumed)
                        {
                            _sponsorDTOList = _mapper.Map<List<SponsorDTO>>(sponsorData);
                            _isSponsorsConsumed = true;
                            continue;
                        }
                    }
                }
                var _sponsorDTO = _sponsorDTOList.Where(x => x.SponsorID == common.PrimaryKeyID).FirstOrDefault();
                var result = new SponsorViewModel
                {
                    Sponsors = _sponsorDTOList,
                    Sponsor = _sponsorDTO
                };
                return result;
            }
        ...
        public async Task<SponsorViewModel> PrintSponsorsAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PrintMS_Sponsors";
            SqlParameter[] paramList =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> ApproveSponsorsAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.ApproveMS_Sponsors";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
