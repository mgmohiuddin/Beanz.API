...
{
    public class SubGradeRepository : ISubGradeRepository
    {
        private readonly IMapper _mapper;

        public SubGradeRepository(IMapper mapper)
        {
            _mapper = mapper;
        }

        public async Task<List<SubGradeDTO>> GetSubGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetMS_SubGrades";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@SubGradeID", SqlDbType.Int) { Value = common.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<SubGradeDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BeanzResponseDTO> SetSubGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.SetMS_SubGrades";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> PostSubGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PostMS_SubGrades";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> DelSubGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.DelMS_SubGrades";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<List<BeanzlookupDTO>> LookUpSubGradesAsync(BeanzCommonDTO lookup)
        {
            string _sql = "hrms.LookupMS_SubGrades";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@SubGradeID", SqlDbType.Int) { Value = lookup.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BeanzlookupDTO>(_sql, _parameters);
            return data;
        }

        public async Task<SubGradeViewModel> GetInfoSubGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetInfoMS_SubGrades";
            ...
            var _subGradeDTOList = new List<SubGradeDTO>();
            bool _isSubGradesConsumed = false;
            using (SqlConnection _sqlConnection = new SqlConnection(Utilities.Configuration.ConnectionString))
            {
                using (var objRecord = await SqlMapper.QueryMultipleAsync(_sqlConnection, _sql, p, commandType: CommandType.StoredProcedure))
                {
                    while (!objRecord.IsConsumed)
                    {
                        ...
                        var subGradeData = objTemp.Where(c => c.TableName == "MS_SubGrades");
                        if (subGradeData.Count() > 0 && !_isSubGradesConsumed)
                        {
                            _subGradeDTOList = _mapper.Map<List<SubGradeDTO>>(subGradeData);
                            _isSubGradesConsumed = true;
                            continue;
                        }
                    }
                }
                var _subGradeDTO = _subGradeDTOList.Where(x => x.SubGradeID == common.PrimaryKeyID).FirstOrDefault();
                var result = new SubGradeViewModel
                {
                    SubGrades = _subGradeDTOList,
                    SubGrade = _subGradeDTO
                };
                return result;
            }
        }

        public async Task<SubGradeViewModel> PrintSubGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PrintMS_SubGrades";
            SqlParameter[] paramList =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> ApproveSubGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.ApproveMS_SubGrades";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
