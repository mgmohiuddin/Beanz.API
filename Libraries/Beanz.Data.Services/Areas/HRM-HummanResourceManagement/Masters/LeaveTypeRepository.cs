...
namespace Beanz.Data.Services.Areas.HummanResourceManagement.Masters
{
    public class LeaveTypeRepository : ILeaveTypeRepository
    {
        ...
        public LeaveTypeRepository(IMapper mapper)
        {
            _mapper = mapper;
        }

        public async Task<List<LeaveTypeDTO>> GetLeaveTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetMS_LeaveTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@LeaveTypeID", SqlDbType.Int) { Value = common.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<LeaveTypeDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BeanzResponseDTO> SetLeaveTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.SetMS_LeaveTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> PostLeaveTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PostMS_LeaveTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> DelLeaveTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.DelMS_LeaveTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<List<BeanzlookupDTO>> LookUpLeaveTypesAsync(BeanzCommonDTO lookup)
        {
            string _sql = "hrms.LookupMS_LeaveTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@LeaveTypeID", SqlDbType.Int) { Value = lookup.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BeanzlookupDTO>(_sql, _parameters);
            return data;
        }

        public async Task<LeaveTypeViewModel> GetInfoLeaveTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetInfoMS_LeaveTypes";
            ...
            var _leaveTypeDTOList = new List<LeaveTypeDTO>();
            bool _isLeaveTypesConsumed = false;
            using (SqlConnection _sqlConnection = new SqlConnection(Utilities.Configuration.ConnectionString))
            {
                using (var objRecord = await SqlMapper.QueryMultipleAsync(_sqlConnection, _sql, p, commandType: CommandType.StoredProcedure))
                {
                    while (!objRecord.IsConsumed)
                    {
                        ...
                        var leaveTypeData = objTemp.Where(c => c.TableName == "MS_LeaveTypes");
                        if (leaveTypeData.Count() > 0 && !_isLeaveTypesConsumed)
                        {
                            _leaveTypeDTOList = _mapper.Map<List<LeaveTypeDTO>>(leaveTypeData);
                            _isLeaveTypesConsumed = true;
                            continue;
                        }
                    }
                }
                var _leaveTypeDTO = _leaveTypeDTOList.Where(x => x.LeaveTypeID == common.PrimaryKeyID).FirstOrDefault();
                var result = new LeaveTypeViewModel
                {
                    LeaveTypes = _leaveTypeDTOList,
                    LeaveType = _leaveTypeDTO
                };
                return result;
            }
        }

        public async Task<LeaveTypeViewModel> PrintLeaveTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PrintMS_LeaveTypes";
            SqlParameter[] paramList =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> ApproveLeaveTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.ApproveMS_LeaveTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
