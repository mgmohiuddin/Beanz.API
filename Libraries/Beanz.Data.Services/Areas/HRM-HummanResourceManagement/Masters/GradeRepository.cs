...
namespace Beanz.Data.Services.Areas.HummanResourceManagement.Masters
{
    public class GradeRepository : IGradeRepository
    {
        ...
        public GradeRepository(IMapper mapper)
        {
            _mapper = mapper;
        }

        public async Task<List<GradeDTO>> GetGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetMS_Grades";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@GradeID", SqlDbType.Int) { Value = common.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<GradeDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BeanzResponseDTO> SetGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.SetMS_Grades";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> PostGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PostMS_Grades";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> DelGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.DelMS_Grades";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<List<BeanzlookupDTO>> LookUpGradesAsync(BeanzCommonDTO lookup)
        {
            string _sql = "hrms.LookupMS_Grades";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@GradeID", SqlDbType.Int) { Value = lookup.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BeanzlookupDTO>(_sql, _parameters);
            return data;
        }

        public async Task<GradeViewModel> GetInfoGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetInfoMS_Grades";
            ...
            var _gradeDTOList = new List<GradeDTO>();
            bool _isGradesConsumed = false;
            using (SqlConnection _sqlConnection = new SqlConnection(Utilities.Configuration.ConnectionString))
            {
                using (var objRecord = await SqlMapper.QueryMultipleAsync(_sqlConnection, _sql, p, commandType: CommandType.StoredProcedure))
                {
                    while (!objRecord.IsConsumed)
                    {
                        ...
                        var gradeData = objTemp.Where(c => c.TableName == "MS_Grades");
                        if (gradeData.Count() > 0 && !_isGradesConsumed)
                        {
                            _gradeDTOList = _mapper.Map<List<GradeDTO>>(gradeData);
                            _isGradesConsumed = true;
                            continue;
                        }
                    }
                }
                var _gradeDTO = _gradeDTOList.Where(x => x.GradeID == common.PrimaryKeyID).FirstOrDefault();
                var result = new GradeViewModel
                {
                    Grades = _gradeDTOList,
                    Grade = _gradeDTO
                };
                return result;
            }
        ...
        public async Task<GradeViewModel> PrintGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PrintMS_Grades";
            SqlParameter[] paramList =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> ApproveGradesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.ApproveMS_Grades";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
