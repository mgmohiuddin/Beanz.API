...
namespace Beanz.Data.Services.Areas.HumanResourceManagement.Masters
{
    public class AssetTypeRepository : IAssetTypeRepository
    {
        ...
        public AssetTypeRepository(IMapper mapper)
        {
            _mapper = mapper;
        }

        public async Task<List<AssetTypeDTO>> GetAssetTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetMS_AssetTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@AssetTypeID", SqlDbType.Int) { Value = common.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<AssetTypeDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BeanzResponseDTO> SetAssetTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.SetMS_AssetTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> PostAssetTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PostMS_AssetTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> DelAssetTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.DelMS_AssetTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<List<BeanzlookupDTO>> LookUpAssetTypesAsync(BeanzCommonDTO lookup)
        {
            string _sql = "hrms.LookupMS_AssetTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@AssetTypeID", SqlDbType.Int) { Value = lookup.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BeanzlookupDTO>(_sql, _parameters);
            return data;
        }

        public async Task<AssetTypeViewModel> GetInfoAssetTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetInfoMS_AssetTypes";
            ...
            var _assetTypeDTOList = new List<AssetTypeDTO>();
            bool _isAssetTypesConsumed = false;
            using (SqlConnection _sqlConnection = new SqlConnection(Utilities.Configuration.ConnectionString))
            {
                using (var objRecord = await SqlMapper.QueryMultipleAsync(_sqlConnection, _sql, p, commandType: CommandType.StoredProcedure))
                {
                    while (!objRecord.IsConsumed)
                    {
                        ...
                        var assetTypeData = objTemp.Where(c => c.TableName == "MS_AssetTypes");
                        if (assetTypeData.Count() > 0 && !_isAssetTypesConsumed)
                        {
                            _assetTypeDTOList = _mapper.Map<List<AssetTypeDTO>>(assetTypeData);
                            _isAssetTypesConsumed = true;
                            continue;
                        }
                    }
                }
                var _assetTypeDTO = _assetTypeDTOList.Where(x => x.AssetTypeID == common.PrimaryKeyID).FirstOrDefault();
                var result = new AssetTypeViewModel
                {
                    AssetTypes = _assetTypeDTOList,
                    AssetType = _assetTypeDTO
                };
                return result;
            }
        }

        public async Task<AssetTypeViewModel> PrintAssetTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PrintMS_AssetTypes";
            SqlParameter[] paramList =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> ApproveAssetTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.ApproveMS_AssetTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
