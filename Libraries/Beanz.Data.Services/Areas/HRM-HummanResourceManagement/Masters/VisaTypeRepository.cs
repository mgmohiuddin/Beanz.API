...
namespace Beanz.Data.Services.Areas.HumanResourceManagement.Masters
{
    public class VisaTypeRepository : IVisaTypeRepository
    {
        ...
        public VisaTypeRepository(IMapper mapper)
        {
            _mapper = mapper;
        }

        public async Task<List<VisaTypeDTO>> GetVisaTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetMS_VisaTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@VisaTypeID", SqlDbType.Int) { Value = common.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<VisaTypeDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BeanzResponseDTO> SetVisaTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.SetMS_VisaTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> PostVisaTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PostMS_VisaTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> DelVisaTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.DelMS_VisaTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<List<BeanzlookupDTO>> LookUpVisaTypesAsync(BeanzCommonDTO lookup)
        {
            string _sql = "hrms.LookupMS_VisaTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@VisaTypeID", SqlDbType.Int) { Value = lookup.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BeanzlookupDTO>(_sql, _parameters);
            return data;
        }

        public async Task<VisaTypeViewModel> GetInfoVisaTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.GetInfoMS_VisaTypes";
            ...
            var _visaTypeDTOList = new List<VisaTypeDTO>();
            bool _isVisaTypesConsumed = false;
            using (SqlConnection _sqlConnection = new SqlConnection(Utilities.Configuration.ConnectionString))
            {
                using (var objRecord = await SqlMapper.QueryMultipleAsync(_sqlConnection, _sql, p, commandType: CommandType.StoredProcedure))
                {
                    while (!objRecord.IsConsumed)
                    {
                        ...
                        var visaTypeData = objTemp.Where(c => c.TableName == "MS_VisaTypes");
                        if (visaTypeData.Count() > 0 && !_isVisaTypesConsumed)
                        {
                            _visaTypeDTOList = _mapper.Map<List<VisaTypeDTO>>(visaTypeData);
                            _isVisaTypesConsumed = true;
                            continue;
                        }
                    }
                }
                var _visaTypeDTO = _visaTypeDTOList.Where(x => x.VisaTypeID == common.PrimaryKeyID).FirstOrDefault();
                var result = new VisaTypeViewModel
                {
                    VisaTypes = _visaTypeDTOList,
                    VisaType = _visaTypeDTO
                };
                return result;
            }
        }

        public async Task<VisaTypeViewModel> PrintVisaTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.PrintMS_VisaTypes";
            SqlParameter[] paramList =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> ApproveVisaTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "hrms.ApproveMS_VisaTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
