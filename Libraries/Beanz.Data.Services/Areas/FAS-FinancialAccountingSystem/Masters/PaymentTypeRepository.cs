...
namespace Beanz.Data.Services.Areas.FinancialAccountingSystem.Masters
{
    public class PaymentTypeRepository : IPaymentTypeRepository
    {
        ...
        public PaymentTypeRepository(IMapper mapper)
        {
            _mapper = mapper;
        }

        public async Task<List<PaymentTypeDTO>> GetPaymentTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.GetMS_PaymentTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@PaymentTypeID", SqlDbType.Int) { Value = common.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<PaymentTypeDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BeanzResponseDTO> SetPaymentTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.SetMS_PaymentTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> PostPaymentTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.PostMS_PaymentTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> DelPaymentTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.DelMS_PaymentTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<List<BeanzlookupDTO>> LookUpPaymentTypesAsync(BeanzCommonDTO lookup)
        {
            string _sql = "fas.LookupMS_PaymentTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@PaymentTypeID", SqlDbType.Int) { Value = lookup.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BeanzlookupDTO>(_sql, _parameters);
            return data;
        }

        public async Task<PaymentTypeViewModel> GetInfoPaymentTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.GetInfoMS_PaymentTypes";
            ...
            var _paymentTypeDTOList = new List<PaymentTypeDTO>();
            bool _isPaymentTypesConsumed = false;
            using (SqlConnection _sqlConnection = new SqlConnection(Utilities.Configuration.ConnectionString))
            {
                using (var objRecord = await SqlMapper.QueryMultipleAsync(_sqlConnection, _sql, p, commandType: CommandType.StoredProcedure))
                {
                    while (!objRecord.IsConsumed)
                    {
                        ...
                        var paymentTypeData = objTemp.Where(c => c.TableName == "MS_PaymentTypes");
                        if (paymentTypeData.Count() > 0 && !_isPaymentTypesConsumed)
                        {
                            _paymentTypeDTOList = _mapper.Map<List<PaymentTypeDTO>>(paymentTypeData);
                            _isPaymentTypesConsumed = true;
                            continue;
                        }
                    }
                }
                var _paymentTypeDTO = _paymentTypeDTOList.Where(x => x.PaymentTypeID == common.PrimaryKeyID).FirstOrDefault();
                var result = new PaymentTypeViewModel
                {
                    PaymentTypes = _paymentTypeDTOList,
                    PaymentType = _paymentTypeDTO
                };
                return result;
            }
        }

        public async Task<PaymentTypeViewModel> PrintPaymentTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.PrintMS_PaymentTypes";
            SqlParameter[] paramList =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> ApprovePaymentTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.ApproveMS_PaymentTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
