...
namespace Beanz.Data.Services.Areas.FinancialAccountingSystem.Masters
{
    public class VoucherTypeRepository : IVoucherTypeRepository
    {
        ...
        public VoucherTypeRepository(IMapper mapper)
        {
            _mapper = mapper;
        }

        public async Task<List<VoucherTypeDTO>> GetVoucherTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.GetMS_VoucherTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@VoucherTypeID", SqlDbType.Int) { Value = common.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<VoucherTypeDTO>(_sql, _parameters);
            return data;
        }

        public async Task<BeanzResponseDTO> SetVoucherTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.SetMS_VoucherTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> PostVoucherTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.PostMS_VoucherTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> DelVoucherTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.DelMS_VoucherTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<List<BeanzlookupDTO>> LookUpVoucherTypesAsync(BeanzCommonDTO lookup)
        {
            string _sql = "fas.LookupMS_VoucherTypes";
            SqlParameter[] _parameters =
            {
                ...
                new SqlParameter("@VoucherTypeID", SqlDbType.Int) { Value = lookup.PrimaryKeyID }
            };
            var data = await DAL.GetObjectListWithParametersAsync<BeanzlookupDTO>(_sql, _parameters);
            return data;
        }

        public async Task<VoucherTypeViewModel> GetInfoVoucherTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.GetInfoMS_VoucherTypes";
            ...
            var _voucherTypeDTOList = new List<VoucherTypeDTO>();
            bool _isVoucherTypesConsumed = false;
            using (SqlConnection _sqlConnection = new SqlConnection(Utilities.Configuration.ConnectionString))
            {
                using (var objRecord = await SqlMapper.QueryMultipleAsync(_sqlConnection, _sql, p, commandType: CommandType.StoredProcedure))
                {
                    while (!objRecord.IsConsumed)
                    {
                        ...
                        var voucherTypeData = objTemp.Where(c => c.TableName == "MS_VoucherTypes");
                        if (voucherTypeData.Count() > 0 && !_isVoucherTypesConsumed)
                        {
                            _voucherTypeDTOList = _mapper.Map<List<VoucherTypeDTO>>(voucherTypeData);
                            _isVoucherTypesConsumed = true;
                            continue;
                        }
                    }
                }
                var _voucherTypeDTO = _voucherTypeDTOList.Where(x => x.VoucherTypeID == common.PrimaryKeyID).FirstOrDefault();
                var result = new VoucherTypeViewModel
                {
                    VoucherTypes = _voucherTypeDTOList,
                    VoucherType = _voucherTypeDTO
                };
                return result;
            }
        }

        public async Task<VoucherTypeViewModel> PrintVoucherTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.PrintMS_VoucherTypes";
            SqlParameter[] paramList =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
        ...
        public async Task<BeanzResponseDTO> ApproveVoucherTypesAsync(BeanzCommonDTO common)
        {
            string _sql = "fas.ApproveMS_VoucherTypes";
            SqlParameter[] _parameters =
            {
                new SqlParameter("@CompanyID", SqlDbType.Int) { Value = common.CompanyID },
                new SqlParameter("@UserID", SqlDbType.Int) { Value = common.UserID },
