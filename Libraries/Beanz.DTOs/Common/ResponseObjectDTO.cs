...
namespace Beanz.DTOs.Common
{
    public class ResponseObjectDTO<T>
    {
        ...
        public static ResponseObjectDTO<T> Ok(T data, string message = "Success", int statusCode = 200)
        ...
        public static ResponseObjectDTO<T> Fail(string message, string code, int status, object? errors = null)
        => new()
        {
            Success = false,
            Message = message,
