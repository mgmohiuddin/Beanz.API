...
{
    public class BeanzResponseObjectDTO<T>
    {
        ...
        public static BeanzResponseObjectDTO<T> Ok(T data, string message = "Success", int statusCode = 200)
        ...
        public static BeanzResponseObjectDTO<T> Fail(string message, string code, int status, object? errors = null)
        => new()
        {
            Success = false,
            Message = message,
