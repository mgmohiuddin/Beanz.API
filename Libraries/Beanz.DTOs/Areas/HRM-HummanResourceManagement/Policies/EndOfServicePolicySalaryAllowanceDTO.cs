...
{
    public class EndOfServicePolicySalaryAllowanceDTO
    {
    ...
    public class EndOfServicePolicySalaryAllowanceViewModel
    {
        public List<EndOfServicePolicySalaryAllowanceDTO> EndOfServicePolicySalaryAllowances { get; set; }
        public EndOfServicePolicySalaryAllowanceDTO EndOfServicePolicySalaryAllowance { get; set; }
    }
}
