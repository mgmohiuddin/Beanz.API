...
{
    public class AttendancePolicyEligibleDTO
    {
    ...
    public class AttendancePolicyEligibleViewModel
    {
        public List<AttendancePolicyEligibleDTO> AttendancePolicyEligibles { get; set; }
        public AttendancePolicyEligibleDTO AttendancePolicyEligible { get; set; }
    }
}
