...
{
    public class BusinessTripPolicyPaymentDTO
    {
    ...
    public class BusinessTripPolicyPaymentViewModel
    {
        public List<BusinessTripPolicyPaymentDTO> BusinessTripPolicyPayments { get; set; }
        public BusinessTripPolicyPaymentDTO BusinessTripPolicyPayment { get; set; }
    }
}
