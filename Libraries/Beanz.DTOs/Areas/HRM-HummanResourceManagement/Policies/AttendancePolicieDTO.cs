...
{
    public class AttendancePolicieDTO
    {
    ...
    public class AttendancePolicieViewModel
    {
        public List<AttendancePolicieDTO> AttendancePolicies { get; set; }
        public AttendancePolicieDTO AttendancePolicie { get; set; }
    }
}
