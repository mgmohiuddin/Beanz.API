...
namespace Beanz.DTOs.Areas.HumanResourceManagement.Policies
{
    ...
    public class LeavePolicieViewModel
    {
        public List<LeavePolicieDTO> LeavePolicies { get; set; }
        public LeavePolicieDTO LeavePolicie { get; set; }
    }
}
