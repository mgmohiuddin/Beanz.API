...
{
    public class TicketClassTypeDTO
    {
    ...
    public class TicketClassTypeViewModel
    {
        public List<TicketClassTypeDTO> TicketClassTypes { get; set; }
        public TicketClassTypeDTO TicketClassType { get; set; }
    }
}
