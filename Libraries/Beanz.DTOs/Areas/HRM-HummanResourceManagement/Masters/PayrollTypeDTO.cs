...
namespace Beanz.DTOs.Areas.HumanResourceManagement.Masters
{
    public class PayrollTypeDTO
    {
        ...
        public string PayrollTypeAlias { get; set; }
    ...
    public class PayrollTypeViewModel
    {
        public List<PayrollTypeDTO> PayrollTypes { get; set; }
        public PayrollTypeDTO PayrollType { get; set; }
    }
}
