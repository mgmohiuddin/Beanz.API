...
namespace Beanz.DTOs.Areas.HummanResourceManagement.Masters
{
    ...
    public class AdvanceSalaryTypeViewModel
    {
        public List<AdvanceSalaryTypeDTO> AdvanceSalaryTypes { get; set; }
        public AdvanceSalaryTypeDTO AdvanceSalaryType { get; set; }
    }
}
