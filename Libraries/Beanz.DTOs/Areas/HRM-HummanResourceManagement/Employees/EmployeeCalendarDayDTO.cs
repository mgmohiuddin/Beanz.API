...
namespace Beanz.DTOs.Areas.HummanResourceManagement.Employees
{
    ...
    public class EmployeeCalendarDayViewModel
    {
        public List<EmployeeCalendarDayDTO> EmployeeCalendarDays { get; set; }
        public EmployeeCalendarDayDTO EmployeeCalendarDay { get; set; }
    }
}
