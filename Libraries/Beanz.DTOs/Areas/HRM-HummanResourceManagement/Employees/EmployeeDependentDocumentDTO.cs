...
{
    public class EmployeeDependentDocumentDTO
    {
    ...
    public class EmployeeDependentDocumentViewModel
    {
        public List<EmployeeDependentDocumentDTO> EmployeeDependentDocuments { get; set; }
        public EmployeeDependentDocumentDTO EmployeeDependentDocument { get; set; }
    }
}
