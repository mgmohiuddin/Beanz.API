...
namespace Beanz.DTOs.Areas.FinancialAccountingSystem.Transactions
{
    public class AccountOpeningDetailDTO
    {
    ...
    public class AccountOpeningDetailViewModel
    {
        public List<AccountOpeningDetailDTO> AccountOpeningDetails { get; set; }
        public AccountOpeningDetailDTO AccountOpeningDetail { get; set; }
    }
}
