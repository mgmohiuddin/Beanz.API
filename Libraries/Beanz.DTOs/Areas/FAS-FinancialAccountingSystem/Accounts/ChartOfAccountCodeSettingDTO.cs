...
{
    public class ChartOfAccountCodeSettingDTO
    {
    ...
    public class ChartOfAccountCodeSettingViewModel
    {
        public List<ChartOfAccountCodeSettingDTO> ChartOfAccountCodeSettings { get; set; }
        public ChartOfAccountCodeSettingDTO ChartOfAccountCodeSetting { get; set; }
    }
}
